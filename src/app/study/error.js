...
export default function Error({ reset }) {
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 14, background: "var(--bg-base)", textAlign: "center", padding: 24 }}>
      <div style={{ fontSize: 17, fontWeight: 700, color: "var(--text-primary)" }}>Study session interrupted</div>
      <p style={{ fontSize: 13, color: "var(--text-tertiary)", maxWidth: 320, lineHeight: 1.6, margin: 0 }}>An error stopped your review cards from loading. Your progress is saved.</p>
