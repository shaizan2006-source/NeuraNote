...
export default function Card({
  ...
  const base = {
    ...
    border: dashed ? '1px dashed rgba(255,255,255,0.1)' : active || hovered ? '1px solid color-mix(in srgb, var(--accent) 30%, transparent)' : '1px solid rgba(255,255,255,0.06)',
    background: dashed ? 'rgba(255,255,255,0.015)' : active ? 'color-mix(in srgb, var(--accent) 10%, transparent)' : hovered ? 'rgba(255,255,255,0.04)' : 'rgba(255,255,255,0.025)',
